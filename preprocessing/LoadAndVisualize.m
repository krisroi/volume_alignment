path = '/Users/kristofferroise/project/patient_data_proc/';
group = "DataStOlavs19to28/";
patient = "p22_3115007/";

%load the dataset
hdfdata1 = HdfImport(strcat(path, group, patient, 'J65BP1R0_proc.h5'));
hdfdata2 = HdfImport(strcat(path, group, patient, 'J65BP1R2_proc.h5'));
