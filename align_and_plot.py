...
=======
def plot_fixed_moving(fixed_volume, moving_volume, warped_volume):
    ...
    ax[0, 0].imshow(fixed_xslice, origin='left', cmap='copper', alpha=0.5)
    ax[0, 0].imshow(moving_xslice, origin='left', cmap='gray', alpha=0.5)
    ax[0, 0].set_xlim([0, fixed_volume.shape[1]])
    ax[0, 0].set_ylim([fixed_volume.shape[2], 0])

    ax[0, 1].imshow(fixed_yslice, origin='middle', cmap='copper', alpha=0.5)
    ax[0, 1].imshow(moving_yslice, origin='middle', cmap='gray', alpha=0.5)
    ax[0, 1].set_xlim([0, fixed_volume.shape[1]])
    ax[0, 1].set_ylim([fixed_volume.shape[3], 0])

    ax[0, 2].imshow(fixed_zslice, origin='right', cmap='copper', alpha=0.5)
    ax[0, 2].imshow(moving_zslice, origin='right', cmap='gray', alpha=0.5)
    ax[0, 2].set_xlim([0, fixed_volume.shape[2]])
    ax[0, 2].set_ylim([fixed_volume.shape[3], 0])


    ax[1, 0].imshow(fixed_xslice, origin='left', cmap='copper', alpha=0.5)
    ax[1, 0].imshow(warped_xslice, origin='left', cmap='gray', alpha=0.5)
    ax[1, 0].set_xlim([0, fixed_volume.shape[1]])
    ax[1, 0].set_ylim([fixed_volume.shape[2], 0])

    ax[1, 1].imshow(fixed_yslice, origin='middle', cmap='copper', alpha=0.5)
    ax[1, 1].imshow(warped_yslice, origin='middle', cmap='gray', alpha=0.5)
    ax[1, 1].set_xlim([0, fixed_volume.shape[1]])
    ax[1, 1].set_ylim([fixed_volume.shape[3], 0])

    ax[1, 2].imshow(fixed_zslice, origin='right', cmap='copper', alpha=0.5)
    ax[1, 2].imshow(warped_zslice, origin='right', cmap='gray', alpha=0.5)
>>>>>>> 42baed28b422bcde7b76805a172fe565efa41aad
...
=======
def align(theta_file, path_to_h5files):
>>>>>>> 42baed28b422bcde7b76805a172fe565efa41aad
...
=======
    align(theta_file, path_to_h5files)
>>>>>>> 42baed28b422bcde7b76805a172fe565efa41aad
